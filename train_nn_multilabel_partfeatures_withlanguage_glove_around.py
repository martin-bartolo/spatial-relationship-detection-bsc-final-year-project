...
for d in dict.values():
    ...
    feats.append([d['features']["AreaObj1_Norm_wt_Image"],
             d['features']["AreaObj2_Norm_wt_Image"],
             d['features']["AreaObj1_Norm_wt_Union"],
...
#save the scalar
filename = './models/scalar_partfeatures_withlanguage_glove_around.sav'
...
#save the model
filename = './models/multilabel_model_partfeatures_withlanguage_glove_around.sav'
