...
#save the scalar
filename = './models/scalar_partfeatures_withlanguage.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=0, hidden_layer_sizes=(50,50,50), beta_1=0.9, beta_2=0.997)

##find best hyper parameters
#distributions = {'beta_1': [0.9,0.91,0.92,0.93,0.94,0.95,.96,0.97,0.98,0.99], 'beta_2': [0.995,0.996,0.997,0.998,0.999,1]}
...
#save the model
filename = './models/multilabel_model_partfeatures_withlanguage.sav'
