...
for d in dict.values():
    ...
    feats.append([d['features']["AreaObj1_Norm_wt_Union"],
             ...
             d['features']["DistBtCentr_Norm_wt_UnionDiag"],
...
#save the scalar
filename = './models/scalar_partfeatures_withlanguage_glove_above.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=2, hidden_layer_sizes=(40,40,40), beta_1=0.88, beta_2=0.997)
...
#save the model
filename = './models/multilabel_model_partfeatures_withlanguage_glove_above.sav'
