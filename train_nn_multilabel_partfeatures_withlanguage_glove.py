...
#save the scalar
filename = './models/scalar_partfeatures_withlanguage_glove.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=1, hidden_layer_sizes=(40,40,40), beta_1=0.93, beta_2=0.999)
...
#save the model
filename = './models/multilabel_model_partfeatures_withlanguage_glove.sav'
