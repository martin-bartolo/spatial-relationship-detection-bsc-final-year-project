...
#save the scalar
filename = './models/scalar_fullfeatures_withlanguage_word2vec.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=0, hidden_layer_sizes=(50,50,50), beta_1=0.85, beta_2=0.999)
...
#save the model
filename = './models/multilabel_model_fullfeatures_withlanguage_word2vec.sav'
