...
#save the scalar
filename = './models/scalar_fullfeatures.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=0, hidden_layer_sizes=(50,50,50), beta_1=0.9, beta_2=0.996)
...
#distributions = {'beta_1': [0.85,0.86,0.87,0.88,0.89,0.9,0.91,0.92,0.93,0.94,0.95], 'beta_2': [0.995,0.996,0.997,0.998,0.999,1]}
...
#save the model
filename = './models/multilabel_model_fullfeatures.sav'
