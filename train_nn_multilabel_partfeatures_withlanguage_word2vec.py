...
file = open("./tensorflow_yolov4_tflite/data/dataset/word2vec_voc.txt", mode="r", encoding="utf-8")
lines = file.readlines()
word2vec_dict = {}

for line in lines:
    split_line = line.strip("\n").split(',')
    vec = [float(i) for i in split_line[2:]]
...
#save the scalar
filename = './models/scalar_partfeatures_withlanguage_word2vec.sav'
pickle.dump(scaler, open(filename, 'wb'))

#create MLPClassifier instance
classifier = MLPClassifier(activation='relu', solver='adam', random_state=0, hidden_layer_sizes=(50,50,50), beta_1=0.95, beta_2=0.998)
...
#save the model
filename = './models/multilabel_model_partfeatures_withlanguage_word2vec.sav'
